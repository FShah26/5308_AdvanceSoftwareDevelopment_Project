...
public class ManageLecturePersistence implements IManageLecturePersistence {
    ...
    public ResultSet getAllLectures(String facultyId) throws SQLException {
        ...
        statement.setString(PARAMETER_INDEX_1, facultyId);
    ...
    public boolean addLecture(String facultyId, String courseId, String lecTopic, Date lecDate) throws SQLException {
        ...
        statement.registerOutParameter(PARAMETER_INDEX_5, Types.BOOLEAN);
        statement.setString(PARAMETER_INDEX_1, facultyId);
        statement.setString(PARAMETER_INDEX_2, courseId);
        statement.setString(PARAMETER_INDEX_3, lecTopic);
        statement.setTimestamp(PARAMETER_INDEX_4, new java.sql.Timestamp(lecDate.getTime()));
        statement.execute();
    ...
    public boolean updateLecture(String lecId, String lecAgenda, Date lecDate) throws SQLException {
        ...
        statement.registerOutParameter(PARAMETER_INDEX_4, Types.BOOLEAN);
        statement.setString(PARAMETER_INDEX_1, lecId);
        statement.setString(PARAMETER_INDEX_2, lecAgenda);
        statement.setTimestamp(PARAMETER_INDEX_3, new java.sql.Timestamp(lecDate.getTime()));
        statement.execute();
        return statement.getBoolean(PARAMETER_NAME);
    }
    ...
    public boolean deleteLecture(String lectureId) throws SQLException {
        ...
        statement.registerOutParameter(PARAMETER_INDEX_2, Types.BOOLEAN);
        statement.setString(PARAMETER_INDEX_1, lectureId);
        statement.execute();
        return statement.getBoolean(PARAMETER_NAME);
    }
